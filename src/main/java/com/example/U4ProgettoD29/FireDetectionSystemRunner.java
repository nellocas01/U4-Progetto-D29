...
@Component
public class FireDetectionSystemRunner implements CommandLineRunner {
	@Autowired
	...
	public FireDetectionSystemRunner(ControlCenter controlCenter, FireProbeFactory fireProbeFactory) {
